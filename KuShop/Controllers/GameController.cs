...
namespace KuShop.Controllers
{
    public class GameController : Controller
    {
        ...
        public readonly ZteamDbContext _db;
        //สร้าง Constructor สำหรับ Controller เพื่อใช้ obj ของ DBContext
        public GameController(ZteamDbContext db) { _db = db; }
        ...
        public IActionResult Index(string? stext) //ค่าที่รับมาจาก View (Form)
        {
            ...
            var pdvm = from p in _db.Games
                       ...
                       where p.GameName.Contains(stext) ||
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Pdt"] = new SelectList(_db.Genres, "GenreId", "GenreName");
            ViewData["Developer"] = new SelectList(_db.Devs, "DevId", "DevName");
            return View();
        }
        ...
        public IActionResult Create(Game obj)
        {
            try
            {
                ...
                {
                    _db.Games.Add(obj);  //ส่งคำสั่ง Add ผ่าน DBContext
        ...
        public IActionResult Edit(string id)
        {
            ...
            ViewData["Pdt"] = new SelectList(_db.Genres, "GenreId", "GenreName", obj.GameId);
            ViewData["Developer"] = new SelectList(_db.Devs, "DevId", "DevName", obj.DevId);
            return View(obj);
        }
        ...
        public IActionResult Edit(Game obj)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    _db.Games.Update(obj);  //ส่งคำสั่ง Update ผ่าน DBContext
                    _db.SaveChanges(); // Execute คำสั่ง
                    return RedirectToAction("Index"); //ย้ายหน้าทำงานไปที่ Action Index
                }
            }
        ...
        public IActionResult Delete(String id)
        {
            ...
            ViewBag.pdtName = _db.Genres.FirstOrDefault(pt => pt.GenreId == obj.GenreId).GenreName;
        ...
        public IActionResult DeletePost(string Pdid)
        {
            try
            {
                ...
                var obj = _db.Games.Find(Pdid);
                if (obj == null)
                {
                    ViewBag.ErrorMessage = "ไม่พบข้อมูล";
                    return RedirectToAction("Index");
                }
                _db.Games.Remove(obj); // สั่ง Remove
                _db.SaveChanges(); //Execute คำสั่ง
