...
namespace KuShop.Controllers
{
    public class BuyingController : Controller
    {
        ...
        public BuyingController(ZteamDbContext db)
        { _db = db; }
        ...
        public IActionResult Index()
        {
            ...
            var pd = from b in _db.Buyings
                     join s in _db.Publishers on b.SupId equals s.PubId into join_b_s
        ...
        public IActionResult Create()
        {
            ...
            ViewData["Sup"] = new SelectList(_db.Publishers, "PubId", "PubName");
            return View();
        }
        ...
        public IActionResult Show(string buyid)
        {
            ...
            foreach (var s in buying)
            {
                ...
                ViewBag.SupName = _db.Publishers.FirstOrDefault(sp => sp.PubId == s.SupId).PubName;
            }
            ...
            var buydtl = from bd in _db.BuyDtls
                         join p in _db.Games on bd.PdId equals p.GameId into join_bd_p
        ...
        public IActionResult Edit(string buyid)
        {
            ...
            ViewData["PubId"] = new SelectList(_db.Publishers, "PubId", "PubName", obj.SupId);
            return View(obj);
        }
        ...
        public IActionResult Delete(string buyid)
        {
            ...
            foreach (var item in detail)
            {
                ...
                ////////////
                //Update Stock สินค้า
                var pd = _db.Games.Find(item.PdId);
        ...
        public IActionResult CreateDtl(string buyid)
        {
            ...
            ViewData["GameId"] = new SelectList(_db.Games, "GameId", "GameName");
