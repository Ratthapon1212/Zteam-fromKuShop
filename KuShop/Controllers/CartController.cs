...
namespace KuShop.Controllers
{
    public class CartController : Controller
    {
        ...
        public CartController(ZteamDbContext db) { _db = db; }
        ...
        public IActionResult AddDtl(string pdid)
        {
            ...
            if (cdtl.Count() == 0)
            {
                ...
                obj.GameId = pdid;
                obj.CdtlQty = 1;
                obj.CdtlPrice = pd.GamePrice;
                obj.CdtlMoney = pd.GamePrice * 1;
            ...
            else
            {
                foreach (var obj in cdtl)
                {
                    ...
                    obj.CdtlMoney = pd.GamePrice * (obj.CdtlQty);
        ...
        public IActionResult Show(string cartid)
        {
            ...
            var cartdtl = from ctd in _db.CartDtls
                          join p in _db.Games on ctd.GameId equals p.GameId
                              into join_ctd_p
        ...
        public IActionResult Confirm(string cartid)
        {
            ...
            foreach (var detail in cartdtl)
            {
                ...
                Game pd = _db.Games.Find(detail.GameId);
