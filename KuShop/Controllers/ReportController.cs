...
namespace KuShop.Controllers
{
    public class ReportController : Controller
    {
        ...
        public ReportController(ZteamDbContext db) { _db = db; }
...
var rep = from cd in _db.CartDtls
            ...
            join p in _db.Games on cd.GameId equals p.GameId into join_cd_p
            ...
            group cd by new { cd.GameId, cd_p.GameName } into g
            select new RepSale
            {
                GameId = g.Key.GameId,
